...
public class LivePlay extends JCVideoPlayer {
    ...
    public LivePlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.start) {
//            if (windowVisibilityChanged != null) {
//                windowVisibilityChanged.getCurPlay(url);
//            }
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        ...
        if (windowVisibilityChanged != null)
            windowVisibilityChanged.onWindowVisibilityChanged(this, visibility, url);

    }

    private WindowVisibilityChanged windowVisibilityChanged;

    public void setWindowVisibilityChanged(WindowVisibilityChanged windowVisibilityChanged) {
        this.windowVisibilityChanged = windowVisibilityChanged;
    }

    public interface WindowVisibilityChanged {
        void onWindowVisibilityChanged(LivePlay livePlay, int visibility, String url);
    }
}
